    ...
    public partial class frmCustomersRecord2 : Form
    {
        ...
        public void GetData()
        {
            try
            {
               ...
               // con = new OleDbConnection(cs);
                con.Open();
                cmd = new MySqlCommand("SELECT CustomerID,Customername,address,city,zipcode,Phone,email,mobileno,notes from Customer order by Customername", con);
        ...
        private void txtCustomers_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                cmd = new MySqlCommand("SELECT CustomerID,Customername,address,city,zipcode,Phone,email,mobileno,notes from customer where Customername like '" + txtCustomers.Text + "%' order by Customername", con);
                MySqlDataAdapter myDA = new MySqlDataAdapter(cmd);
              //  OleDbDataAdapter myDA = new OleDbDataAdapter(cmd);
                DataSet myDataSet = new DataSet();
                myDA.Fill(myDataSet, "Customer");
