    ...
    public partial class frmSalesRecord : Form
    {
        ...
        public void FillCombo()
        {
            ...
            try
            {
                ...
                adp.SelectCommand = new MySqlCommand("SELECT  distinct Customername FROM customer where sales.CustomerID=customer.CustomerID", con);
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //   con = new OleDbConnection(cs);
                con.Open();
                cmd = new MySqlCommand("SELECT orderID,orderDate,CustomerID,Customername,GrandTotal,TotalPayment,paymentDue from sales,customer where sales.customerID=customer.CustomerID and orderID between #" + dtpInvoiceDateFrom.Text + "# And #" + dtpInvoiceDateTo.Text + "# order by orderDate desc", con);
        ...
        private void Button5_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // con = new OleDbConnection(cs);
                con.Open();
                cmd = new MySqlCommand("SELECT orderID, orderDate, sales.CustomerID, Customername, grandTotal, TotalPayment, PaymentDue from sales WHERE sales.CustomerID = customer.CustomerID and orderDate between #" + DateTimePicker2.Text + "# And #" + DateTimePicker1.Text + "# and PaymentDue > 0 order by orderDate desc", con);
